...
silent only
cd ~/accelerated_cs/winter_2020/cs320/lab9
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 grammar.txt
badd +1 badsyntax.mini
badd +1 test0.mini
badd +1 MiniCompiler.java
badd +1 analysis_test.mini
badd +1 test1.mini
badd +1 shape.mini
badd +1 test2.mini
badd +1 bad.mini
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 53 - ((27 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
53
normal! 05|
tabedit ast/BinExpr.java
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 109 - ((34 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
109
