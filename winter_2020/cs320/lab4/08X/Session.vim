...
silent only
cd ~/accelerated_cs/winter_2020/cs320/lab4/08X
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 AdjSetGraph.java
badd +0 Graph.java
badd +0 GraphTest.java
badd +0 GraphUtils.java
badd +0 ../07/Graph.java
badd +0 ../07/GraphUtils.java
argglobal
silent! argdel *
$argadd AdjSetGraph.java
$argadd Graph.java
$argadd GraphTest.java
$argadd GraphUtils.java
set stal=2
edit AdjSetGraph.java
