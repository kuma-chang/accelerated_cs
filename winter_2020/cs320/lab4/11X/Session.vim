...
silent only
cd ~/accelerated_cs/winter_2020/cs320/lab4/11X
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 BreadthFirstPaths.java
badd +0 DOS.java
badd +0 Graph.java
badd +0 GraphTest.java
badd +0 GraphUtils.java
badd +0 ../10X/GraphUtils.java
badd +0 ../08X/GraphTest.java
argglobal
silent! argdel *
$argadd BreadthFirstPaths.java
$argadd DOS.java
$argadd Graph.java
$argadd GraphTest.java
$argadd GraphUtils.java
set stal=2
edit BreadthFirstPaths.java
...
argglobal
4argu
if bufexists('../08X/GraphTest.java') | buffer ../08X/GraphTest.java | else | edit ../08X/GraphTest.java | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
argglobal
5argu
if bufexists('../10X/GraphUtils.java') | buffer ../10X/GraphUtils.java | else | edit ../10X/GraphUtils.java | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 37 - ((24 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
37
