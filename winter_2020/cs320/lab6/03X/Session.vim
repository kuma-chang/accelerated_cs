...
silent only
cd ~/accelerated_cs/winter_2020/cs320/lab6/03X
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 graph.py
badd +0 ../../lab4/10X/GraphUtils.java
badd +0 ../02/sols/wordcount.py
badd +0 tinyG.ig
argglobal
silent! argdel *
$argadd graph.py
...
wincmd w
argglobal
if bufexists('../../lab4/10X/GraphUtils.java') | buffer ../../lab4/10X/GraphUtils.java | else | edit ../../lab4/10X/GraphUtils.java | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 42 - ((9 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
42
