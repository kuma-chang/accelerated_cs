...
silent only
cd ~/accelerated_cs/winter_2020/cs320/lab6/04X
...
badd +0 bargains.py
badd +0 ../03X/graph.py
badd +0 example1.input
badd +0 example1.bargains
argglobal
silent! argdel *
$argadd bargains.py
set stal=2
...
silent! normal! zE
let s:l = 55 - ((8 * winheight(0) + 24) / 48)
...
wincmd w
argglobal
if bufexists('bargains.py') | buffer bargains.py | else | edit bargains.py | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 33 - ((26 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
