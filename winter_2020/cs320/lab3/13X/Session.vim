...
silent only
cd ~/accelerated_cs/winter_2020/cs320/lab3/13X
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 Parser.java
badd +55 ../../lab2/07/Parser.java
badd +0 Exp.java
badd +0 NumExp.java
badd +0 NegExp.java
badd +59 ../12X/Parser.java
badd +0 AddExp.java
badd +0 MulExp.java
badd +0 SubExp.java
badd +0 DivExp.java
...
silent! normal! zE
let s:l = 83 - ((16 * winheight(0) + 24) / 49)
...
wincmd w
argglobal
if bufexists('Parser.java') | buffer Parser.java | else | edit Parser.java | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 52 - ((25 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
52
...
wincmd w
argglobal
if bufexists('NumExp.java') | buffer NumExp.java | else | edit NumExp.java | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
wincmd w
argglobal
if bufexists('Exp.java') | buffer Exp.java | else | edit Exp.java | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
wincmd w
argglobal
if bufexists('AddExp.java') | buffer AddExp.java | else | edit AddExp.java | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
wincmd w
argglobal
if bufexists('SubExp.java') | buffer SubExp.java | else | edit SubExp.java | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
