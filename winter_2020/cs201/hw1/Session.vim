...
silent only
cd ~/accelerated_cs/winter_2020/cs201/hw1
...
badd +0 board.c
badd +0 Makefile
badd +2 monte_carlo_test.h
badd +10 monte_carlo_test.c
argglobal
silent! argdel *
$argadd hw1_plinko.c
set stal=2
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 97 - ((22 * winheight(0) + 24) / 48)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
97
...
wincmd w
argglobal
if bufexists('monte_carlo_test.h') | buffer monte_carlo_test.h | else | edit monte_carlo_test.h | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
