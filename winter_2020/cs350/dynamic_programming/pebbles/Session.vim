...
silent only
cd ~/accelerated_cs/winter_2020/cs350/dynamic_programming/pebbles
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 pebble_collection.c
badd +0 ../../coins/chang_m_lab6_fibonacci_momoized.c
argglobal
silent! argdel *
$argadd pebble_collection.c
set stal=2
edit pebble_collection.c
...
silent! normal! zE
let s:l = 33 - ((25 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
33
normal! 0
tabedit ../../coins/chang_m_lab6_fibonacci_momoized.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
