...
silent only
cd ~/accelerated_cs/winter_2020/cs350/dynamic_programming/min_sum_descent
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 min_sum_descent.c
badd +0 ../N_choose_K/n_choose_k.c
badd +0 ../pebbles/pebble_collection.c
badd +0 test.txt
argglobal
silent! argdel *
$argadd min_sum_descent.c
set stal=2
edit min_sum_descent.c
...
silent! normal! zE
let s:l = 46 - ((20 * winheight(0) + 24) / 49)
...
12
normal! 0
tabedit ../N_choose_K/n_choose_k.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
62
normal! 0
tabedit ../pebbles/pebble_collection.c
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
