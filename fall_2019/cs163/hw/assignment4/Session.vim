...
silent only
cd ~/accelerated_cs/fall_2019/cs163/hw/assignment4
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 cards_players.cpp
badd +0 main.cpp
badd +1 uno.cpp
badd +0 cards_players.h
badd +0 uno.h
argglobal
silent! argdel *
$argadd cards_players.cpp
$argadd main.cpp
$argadd uno.cpp
$argadd cards_players.h
$argadd uno.h
set stal=2
edit main.cpp
...
argglobal
4argu
if bufexists('cards_players.cpp') | buffer cards_players.cpp | else | edit cards_players.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
argglobal
5argu
if bufexists('uno.cpp') | buffer uno.cpp | else | edit uno.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
