...
silent only
cd ~/accelerated_cs/fall_2019/cs163/hw/assignment5
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 main.cpp
badd +1 rational_number.cpp
badd +1 rational_number.h
badd +1 Makefile
badd +0 template.h
badd +0 template.cpp
argglobal
silent! argdel *
$argadd main.cpp
$argadd rational_number.cpp
$argadd rational_number.h
$argadd Makefile
set stal=2
edit main.cpp
...
argglobal
3argu
if bufexists('rational_number.cpp') | buffer rational_number.cpp | else | edit rational_number.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 66 - ((28 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
66
...
exe 'vert 2resize ' . ((&columns * 103 + 104) / 208)
argglobal
if bufexists('template.cpp') | buffer template.cpp | else | edit template.cpp | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
wincmd w
argglobal
if bufexists('template.h') | buffer template.h | else | edit template.h | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
